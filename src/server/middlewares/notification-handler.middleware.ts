...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'purchase_order.create': {
    roles: ['owner', 'procurement-manager'],
    key: 'new-purchase-order',
    tenantPath: ['organization', 'purchase_order'],
    userPath: [],
  },
...
const ownerRoles: string[] = ['procurement-manager'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['owner', 'procurement-manager'];
