  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Proc - Streamlining Your Business with Efficient Purchase Management and Procurement Solutions."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Proc - Streamlining Your Business with Efficient Purchase Management and Procurement Solutions.`}
            </Text>
            <Box
            ...
            >
              <Stack direction="column" spacing={6}>
                <Card userTypeName="Procurement Manager" type="procurement-manager" />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
